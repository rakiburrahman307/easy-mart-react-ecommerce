...
const AllProductsSummery = (props) => {
    ...
    return (
        <div className="tmp-all-products-summery-container" onClick={handleProductDetails}>
            <div className="tmp-all-products-summery-image">
                ...
                <div className="hover-box">
                    <ul>
                        <li style={{backgroundColor: `${getStarting?.primaryColor}`}}><button onClick={handleProductDetails}><FontAwesomeIcon icon={faEye} /></button></li>
            ...
            <div style={{padding: '20px 20px 10px'}}>
                ...
                <div className="d-flex align-items-center">
                    {   discount > 0 ?
                        <>
                            <p style={{textDecoration: 'line-through', fontWeight: '400'}}>{getStarting?.currency} {offerPrice.toFixed(0)}</p>
                            &nbsp;&nbsp;
                        </>
                        :
                        ''
