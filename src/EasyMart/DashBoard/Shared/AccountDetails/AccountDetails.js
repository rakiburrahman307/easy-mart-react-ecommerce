      ...
      <div className='tmp-account-container'>
        <div className='tmp-account-inner'>
          ...
          <form onSubmit={handleSubmit(onUserInformationUpdate)}>
            ...
            {vendorUser?.vendor && (
              <input
                defaultValue={vendorUser.vendors_name}
                placeholder='Enter Your Vendor Name *'
                {...register("vendors_name")}
                style={{
                  border: `1px solid ${getStarting?.primaryColor}`,
                  opacity: 0.5,
                }}
            ...
            <input
              ...
              style={{
                border: `1px solid ${getStarting?.primaryColor}`,
                opacity: userInfo?.email ? 0.5 : 1,
              }}
              readOnly={userInfo?.email && true}
            />
            <input
              ...
              style={{
                border: `1px solid ${getStarting?.primaryColor}`,
                opacity: userInfo?.phoneNumber ? 0.5 : 1,
              }}
              readOnly={userInfo?.phoneNumber && true}
            />
            <input
            ...
            {!ifVendor && !admin && (
              <p
                onClick={() => setCreateVendors(!createVendors)}
